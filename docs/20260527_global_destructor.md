...
| Layout | Memory |
|--------|--------|
| Before: 80 B struct x 189.7M + ~3.3 GB heap (104M non-SSO strings) | ~18.5 GB |
| After: 96 B struct x 189.7M, no heap | ~18.2 GB |
| **Net** | **-300 MB** |
...
| Layout | Memory |
|--------|--------|
| Before: 64 B struct x 189.7M + ~3.2 GB heap (104M non-SSO strings) | ~14.5 GB |
| After: 72 B struct x 189.7M, no heap | ~12.7 GB |
| **Net** | **-1.8 GB** |
