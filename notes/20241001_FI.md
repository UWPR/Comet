...
See [notes/2026010_FI](/notes/2026010_FI.html) for new/updated run stats on updated Comet-FI.
...
- Protein n-term and c-term variable modifications are not supported in this initial FI release.
  This functionality is expected to be added soon. This means that variable
...
- [fragindex_max_fragmentmass](/Comet/parameters/parameters_202402/fragindex_max_fragmentmass.html)
...
- Same human forward + reverse sequences, *no enzyme constraint*,
  ...
  The .idx creation step consumed 106 GB RAM and took 12:40.


### 2025/11/12 simplied fragment ion index

With release [v2025.03.0](https://uwpr.github.io/Comet/releases/release_202503.html),the fragment ion index
was simplified, removing thread and precursor mass range dimensions. This greatly simplified the index but
didn't significantly affect the performance (search times).

Although I see search times vary, based on different compilations of the code and when I run the timings,
this plot shows one example comparing the fragment ion index search performance for release 2025.03.0 vs.
2025.02.0 vs. the old peptide indexing.

![Comet index search histogram](https://uwpr.github.io/Comet/notes/20251112_FI_histogram.png)
