...
run with MS/MS spectra acquired in the Orbitrap.  Peptide length 7 to 50,
...
- Human forward + reverse (193,864 sequence entries),
  variable mods 16M uses 5.2 GB of RAM and completes in 31 seconds.
- Human forward + reverse, tryptic,
  variable mods 16M, 80STY uses 11.3 GB of RAM and
...
- Human forward + reverse sequences, no enzyme constraint, 16M variable mod,
  ...
  and 30 seconds.  Although performed once for every subsequent search,
  it's notable that just creating the plain peptide .idx file takes
