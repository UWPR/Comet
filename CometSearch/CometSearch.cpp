...
// In SearchForPeptides, this is called before each increment of iStartPos
// if the sequence between iStartPos and iEndPos contains a J.
// Need to find/set proper iEndPos in this function.
