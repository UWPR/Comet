...
public:
   ...
   static void initCombinations(int maxPeptideLen, int maxMods);
   ...
   static bool combine(int* modNumbers, unsigned long* bitmasks, int modNumCount, int modStringLen);
   static void testCombine();
   static void testCombine2();
   static void generateModifications(string sequence, int max_mods_per_mod, int* ret_modNumStart, int* ret_modNumCount, char* ALL_MODS, int MOD_CNT);
   static void getModificationCombinations(const vector<string> modifiableSeqs, int max_mods_per_mod, char* ALL_MODS, int MOD_CNT);
