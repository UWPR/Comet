...
<div id="page">
   <div id="content_full">
      <div class="post hr">
         ...
         <li>"peff_modified_peptide" column is present only if a <a href="peff_format.php">PEFF search</a> is performed.
         ...
         <li>The "modifications" column reports a comma separated list of modifications in the format
...
14937  3    3       1775.648171       1774.655633        5.79E+02  0.4773  0.8161    5.1       2             56          EEESAMSSDRMDCGR  K.EEESAM[15.9949]SSDRMDCGR.K  K        K        sp|Q6WCQ1|MPRIP_HUMAN,tr|J3KSW8|J3KSW8_HUMAN,sp|Q6WCQ1-2|MPRIP_HUMAN  3               6_V_15.994900,13_S_57.021464
         ...
         <p>Sample output for a PEFF search; note the two amino acid substitutions encoded in the modifications column.

<pre>CometVersion 2017.01 rev. 0       20141219_Hela_01        06/05/2017, 04:08:04 PM nextprot_all.peff
