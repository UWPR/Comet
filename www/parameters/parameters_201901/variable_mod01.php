...
<div id="page">
   <div id="content_full">
      <div class="post hr">
         ...
         <ul>
         <li>There are 8 entries/settings that are associated with these parameters:
            <ul>
...
<!--         <li>Modification codes for variable_mod01 through variable_mod09 (for some outputs):  *, #, @, ^, ~, $, %, !, + -->
         <li>The default value is "0.0 X 0 3 -1 0 0 0.0" if this parameter is missing *except* if Comet is
         ...
         <p>Example:
         <br><tt>variable_mod01 = 15.9949 M 0 3 -1 0 0 0.0</tt>
         <br><tt>variable_mod02 = 79.966331 STY 0 3 -1 0 0 97.976896</tt> &nbsp; &nbsp; ... <i>possible phosphorylation on any S, T, Y residue with a neutral loss of 98</i>
         <br><tt>variable_mod02 = 79.966331 STY 0 3 -1 0 1 0.0</tt> &nbsp; &nbsp; ... <i>force peptide IDs to contain at least one phosphorylation mod</i>
         <br><tt>variable_mod01 = 42.010565 nK 0 3 -1 0 0 0.0</tt> &nbsp; &nbsp; ... <i>acetylation mod to lysine and N-terminus of all peptides</i>
         <br><tt>variable_mod01 = 15.994915 n 0 3 0 0 0 0.0</tt> &nbsp; &nbsp; ... <i>oxidation of protein's N-terminus</i>
         <br><tt>variable_mod01 = 28.0 c 0 3 8 1 0 0.0</tt> &nbsp; &nbsp; ... <i>modification applied to C-terminus as long as the C-term residue is one of last 9 residues in protein</i>
         <br><tt>variable_mod03 = -17.026549 Q 0 1 0 2 0 0.0</tt> &nbsp; &nbsp; ... <i>cyclization of N-terminal glutamine to form pyroglutamic acid (elimination of NH3)</i>
         <br><tt>variable_mod04 = -18.010565 E 0 1 0 2 0 0.0</tt> &nbsp; &nbsp; ... <i>cyclization of N-terminal glutamic acid to form pyroglutamic acid (elimination of H2O)</i>
         ...
         <br><tt>variable_mod01 = 42.0 K 0 3 -1 0 0 0.0</tt>
         <br><tt>variable_mod02 =&nbsp; 6.0 R <font color="blue">1</font> 3 -1 0 0 0.0</tt>
         <br><tt>variable_mod03 =&nbsp; 4.0 K <font color="blue">1</font> 3 -1 0 0 0.0 </tt>
         <br><tt>variable_mod04 = 46.0 K <font color="blue">1</font> 3 -1 0 0 0.0</tt>
         <br><tt>variable_mod05 = 10.0 R <font color="red">2</font> 3 -1 0 0 0.0</tt>
         <br><tt>variable_mod06 =&nbsp; 8.0 K <font color="red">2</font> 3 -1 0 0 0.0</tt>
         <br><tt>variable_mod07 = 50.0 K <font color="red">2</font> 3 -1 0 0 0.0</tt>
         <br><tt>variable_mod08 =&nbsp; 0.0 X 0 3 -1 0 0 0.0</tt>
         <br><tt>variable_mod09 =&nbsp; 0.0 X 0 3 -1 0 0 0.0</tt>
