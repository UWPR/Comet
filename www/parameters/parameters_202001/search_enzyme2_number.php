...
<div id="page">
   <div id="content_full">
      <div class="post hr">
         ...
         <h2>Comet parameter: search_enzyme2_number</h2>

         <ul>
         <li>The optional second search enzyme is specified by this parameter.
         <li>If a second digestion enzyme is not applied, set this parameter value to 0.
         <li>If a second enzyme is selected, both the <a href="search_enzyme_number.php">first enzyme</a>
         ...
         <p>Example:
         <br><tt>search_enzyme2_number = 0 </tt> &nbsp; &nbsp; <i>no second enzyme applied</i>
         <br><tt>search_enzyme2_number = 10</tt> &nbsp; &nbsp; <i>digest with chymotrypsin in addition to first enzyme</i></p>
