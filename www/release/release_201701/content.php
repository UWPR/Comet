         ...
         <h1>Comet release 2017.01</h1>
            <ul>
               ...
               <li>Bug fix:  In previous releases when the "force modification be present" parameter option
                   is set (7th parameter entry of <a href="/parameters/parameters_201701/variable_mod01.php">variable_mods</a>" parameter
                   set to 1), Comet could stop permuting modifications for a peptide prematurely. This has
                   been fixed.
               <li>Change how the
