   ...
   <div id="content_full">
      <div class="post hr">
         <h1>Comet release 2021.01</h1>
            ...
            <ul>
               <b>release 2021.01 rev. 0 (2021.01.0), release date 2020/06/23</b>

               <li>Update the expectation value (E-value) calculation by improving the
               determination of the tail region of the xcorr cumulative distribution for
               the linear regression fit.

               <li>New ThreadPool code by D. Shteynberg. The previous code apparently
               ...
               <li>Added a parameter
               "<a href="http://comet-ms.sourceforge.net/parameters/parameters_202101/old_mods_encoding.php">old_mods_encoding</a>"
               ...
               <li>The 
               "<a href="http://comet-ms.sourceforge.net/parameters/parameters_202101/print_expect_score.php">print_expect_score</a>"
               ...
               <li>Added a no digestion (aka "no_cut", aka don't cleave anywhere) entry to the
               comet.params file.

               <li>The Windows Visual Studio solution is updated to compile with v142 build tools
               using Visual Studio 2019.

               <li>This version of Comet will also run using comet.params files from the 2020.01
               releases as there have been no significant changes to the parameter entries.

               <li>Known bug: in the mzIdentML output, the attribute "dBSequence_ref" for element
               ...
               <li>Here's a list of some known bugs that weren't addressed for this release.
               Hopefully I can address some of these in a follow-up maintenance release.
                 <ul>
                   <li>Reported PEFF modification and substitution positions are off by 1 when
                   the start methionine residue is cleaved (using 
                   "<a href="http://comet-ms.sourceforge.net/parameters/parameters_202101/clip_nterm_methionine.php">clip_nterm_methionine</a> = 1").
                   <li>The program will access restricted memory (negative array position) when
                   "<a href="http://comet-ms.sourceforge.net/parameters/parameters_202101/precursor_NL_ions.php">precursor_NL_ions</a> = 1"
                   ...
                   <li>The reported calculated peptide masses can vary by one number in the 6th
                   decimal point between replicate searches. This occurs very infrequently if at all.
                   <li>The preliminary score rank (Sp rank) can vary between replicate searches.
