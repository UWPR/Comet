...
- Compute deltaCn for the decoy results if the decoy search is separate, by @fabianegli in https://github.com/UWPR/Comet/pull/94
- Per request, make idx files independent as before (no requirements of keeping fasta around), by @jke000 in https://github.com/UWPR/Comet/pull/100
